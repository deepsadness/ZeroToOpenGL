...
public class PhotoFilter {
    ...
    private final static String TAG = "PhotoFilter";
    //pos vertex
    ...
    public PhotoFilter(Resources resources) {
        this.mRes = resources;
        initBuffer();
    }
    ...
    public void setBitmap(Bitmap bitmap, float[] matrix, int width, int height) {
        this.matrix = matrix;
        this.mBitmap = bitmap;
    ...
    private void calculateMatrix(int width, int height) {

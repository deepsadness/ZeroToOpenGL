...
public class DecodeThread extends HandlerThread implements VideoDecoderCore.PlayerFeedback {
    ...
    private WeakReference<VideoCaptureFilterView> viewRef;
    private VideoDecoderCore.PlayTask mPlayTask;

    public DecodeThread(VideoCaptureFilterView captureFilterView) {
        super("DecodeThread");
        start();
...
//        mPlayTask.setLoopMode(true);
    ...
    private void setSourceFile(File src) {
        ...
        //设置好之后，要回调设置长宽
        VideoCaptureFilterView videoCaptureFilterView = viewRef.get();

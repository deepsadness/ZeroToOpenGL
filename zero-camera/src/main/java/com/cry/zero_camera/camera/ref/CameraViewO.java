 ...
 * Description:
 */
public class CameraViewO extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    public CameraViewO(Context context) {
        this(context,null);
    }

    public CameraViewO(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
